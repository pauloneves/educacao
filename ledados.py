...
#%%
df_g = df_enem_rio.loc[:, [ 'CO_ESCOLA','NU_NOTA_REDACAO']].groupby('CO_ESCOLA')       .agg(mediana=('NU_NOTA_REDACAO','median'), num=('NU_NOTA_REDACAO','size'))       .sort_values('mediana', ascending=False)
df_g.head()
